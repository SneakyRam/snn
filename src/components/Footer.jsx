    ...
    <footer className="bg-gray-800 border-t border-gray-700 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-space font-bold gradient-text mb-4">Sneaky::Lab</h3>
            <p className="text-gray-400">
              Learn cybersecurity by doing. Real skills, real tools, real progress.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/learn" className="text-gray-400 hover:text-cyan-400 transition-colors">Learn</Link></li>
              <li><Link to="/tools" className="text-gray-400 hover:text-cyan-400 transition-colors">Tools</Link></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2025 Sneaky::Lab. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
